...
mkdir Bluetooth_Tools
# Clone Bluetooth Tool Repos
git clone https://github.com/ZeroChaos-/blue_hydra.git Bluetooth_Tools/
git clone https://github.com/ZeroChaos-/blue_sonar.git Bluetooth_Tools/
